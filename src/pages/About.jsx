...
import aboutImage from "../img/about-img.png"; // Make sure to adjust the path to your image

const About = () => {
  return (
    <section id="about" className="h-screen flex items-center justify-center about-bg mt-16">
